...
export const ROUTES = {
  ...
  walletCreate: '/dashboard/wallets/create',
  walletDetails: (id: string) => `/dashboard/wallets/${id}`,
  walletSettings: '/dashboard/wallets/settings',
  transactions: '/dashboard/transactions',
  transactionCreate: '/dashboard/transactions/create',
  transactionDetails: (id: string) => `/dashboard/transactions/${id}`,
  transactionApprove: (id: string) => `/dashboard/transactions/${id}/approve`,
  pendingTransactions: '/dashboard/transactions/pending',
  ...
  workflowSettings: '/dashboard/settings/approval-workflows',
  portfoxAI: '/dashboard/portfox-ai',
  portfoxAISettings: '/dashboard/portfox-ai/settings',
} as const;
